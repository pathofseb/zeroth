"""Walking task for ZBot - EFFICIENT WALKING VARIANT
This variant emphasizes energy efficiency.
High penalties for contact forces and torques to minimize energy use.
"""
...
class ZbotWalkingTask(ksim.PPOTask[ZbotWalkingTaskConfig]):
    ...
    def get_rewards(self, physics_model: ksim.PhysicsModel) -> list[ksim.Reward]:
        return [
            ...
            ContactForcePenalty(  # Enabled high for efficiency
                 scale=-0.08,  # Increased - minimize impact forces
