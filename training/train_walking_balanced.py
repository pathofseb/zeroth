"""Walking task for ZBot - BALANCED WALKING VARIANT
This variant emphasizes proper foot placement and balance.
Higher rewards for foot orientation and contact patterns.
"""
...
class ZbotWalkingTask(ksim.PPOTask[ZbotWalkingTaskConfig]):
    ...
    def get_rewards(self, physics_model: ksim.PhysicsModel) -> list[ksim.Reward]:
        return [
            ...
            SimpleSingleFootContactReward(scale=0.6, stand_still_threshold=None),  # Increased - proper gait
            FeetAirtimeReward(
                scale=0.15,  # Increased - reward good stepping
                ctrl_dt=self.config.ctrl_dt,
                touchdown_penalty=0.12,  # Increased - penalize bad landings
            ...
            FeetOrientationReward.create(
                ...
                target_rp=(0.0, 0.0),
                error_scale=0.25,
                scale=0.7,  # Increased - critical for balance
            ),
            FeetTooClosePenalty(
