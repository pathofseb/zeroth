"""Walking task for ZBot - STABLE WALKING VARIANT
This variant emphasizes stability and smooth gait.
Higher penalties for instability, smoother movements.
"""
...
class ZbotWalkingTask(ksim.PPOTask[ZbotWalkingTaskConfig]):
    ...
    def get_rewards(self, physics_model: ksim.PhysicsModel) -> list[ksim.Reward]:
        # STABLE WALKING VARIANT: Maximize stability and smoothness
        return [
            ksim.StayAliveReward(scale=1.2),  # Increased
            ksim.UprightReward(scale=1.5),  # Increased for stability
            ksim.NaiveForwardReward(scale=4.0, clip_min=None, clip_max=0.2),  # Moderate forward
