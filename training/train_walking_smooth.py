"""Walking task for ZBot - SMOOTH WALKING VARIANT
This variant emphasizes smooth, efficient gait patterns.
High penalties for jerky movements and accelerations.
"""
...
class ZbotWalkingTask(ksim.PPOTask[ZbotWalkingTaskConfig]):
    ...
    def get_rewards(self, physics_model: ksim.PhysicsModel) -> list[ksim.Reward]:
        return [
            ...
            ksim.ActionVelocityPenalty(scale=-0.05,  scale_by_curriculum=True),  # Enabled high - smooth actions
            ksim.JointVelocityPenalty (scale=-0.05,  scale_by_curriculum=True),  # Enabled high - smooth joints
            ksim.JointAccelerationPenalty(scale=-0.03, scale_by_curriculum=True),  # Enabled - smooth accelerations
