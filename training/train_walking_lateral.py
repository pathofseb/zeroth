"""Walking task for ZBot - LATERAL WALKING VARIANT
This variant allows more lateral movement capability.
Reduced lateral penalties to enable sideways walking.
"""
    ...
    def get_rewards(self, physics_model: ksim.PhysicsModel) -> list[ksim.Reward]:
        return [
            ...
            ksim.LinearVelocityPenalty(
                ...
                in_robot_frame=True,
                norm="l1",
                scale=-0.2,  # Greatly reduced - allow lateral movement for sideways walking
            ),
