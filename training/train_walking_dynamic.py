"""Walking task for ZBot - DYNAMIC WALKING VARIANT
This variant allows dynamic, less conservative movements.
Reduced conservative penalties to encourage exploration.
"""
    ...
    def get_rewards(self, physics_model: ksim.PhysicsModel) -> list[ksim.Reward]:
        return [
            ...
            ksim.ReachabilityPenalty(
                ...
                scale=-0.3,  # Greatly reduced - allow dynamic movements
                squared=False,
                scale_by_curriculum=True,
            ),
        ]
